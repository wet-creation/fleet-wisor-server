...
INSERT INTO driver (ownerId, driverLicenseNumber, name, surname, phone, frontLicensePhotoUrl, backLicensePhotoUrl,
                    salary, birthday)
VALUES (1, 'AA123456', 'Ігор', 'Коваленко', '+380671234567', 'https://example.com/front1.jpg',
        'https://example.com/back1.jpg', 20000, '1985-06-12'),
       (2, 'BB654321', 'Олег', 'Мельник', '+380672345678', 'https://example.com/front2.jpg',
...
VALUES ('Toyota', 1, 1, 'Чорний', 'JH4DB8590SS001234', 120000, 'Camry', 'АА1234ВТ'),
       ('BMW', 2, 2, 'Синій', 'WBA3A5C55CF123456', 80000, 'X5', 'ВС5678СК');
...
-- Заправка машин
INSERT INTO car_fill_up (carId, time, price, checkUrl)
VALUES (1, '2024-07-01 12:00:00', 1200, 'https://example.com/fuel1.jpg'),
 (1, '2025-07-01 00:00:00', 90, 'https://example.com/fuel2321.jpg'),
       (2, '2024-07-02 14:00:00', 1500, 'https://example.com/fuel2.jpg');
